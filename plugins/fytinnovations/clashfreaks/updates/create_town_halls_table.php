...
class CreateTownHallsTable extends Migration
{
    public function up()
    {
        Schema::create('fytinnovations_clashfreaks_town_halls', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->foreign('village_type_id')->references('id')->on('fytinnovations_clashfreaks_village_types');
        });
    }
    ...
    public function down()
    {
        Schema::table('fytinnovations_clashfreaks_town_halls', function ($table) {
            $table->dropForeign('fytinnovations_clashfreaks_town_halls_village_type_id_foreign');
        });
